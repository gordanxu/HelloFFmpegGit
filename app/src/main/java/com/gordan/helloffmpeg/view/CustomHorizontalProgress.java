...
public class CustomHorizontalProgress extends ProgressBar
{
    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        //绘制未做走完的进度
        if (progressX + HorizontalProgresTextOffset  < getWidth() - getPaddingLeft() - getPaddingRight()){//进度走完了,不再画未走完的
            ...
            RectF mRectF2 = new RectF(getPaddingLeft()+progressX + HorizontalProgresTextOffset ,getPaddingTop()-HorizontalProgresUnReachHeight/2,getWidth() - getPaddingLeft() - getPaddingRight(),HorizontalProgresUnReachHeight/2);//圆角 int left, int top, int right, int bottom
