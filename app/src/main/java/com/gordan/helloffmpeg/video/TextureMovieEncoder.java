...
import com.gordan.helloffmpeg.filter.GPUImageFilter;
import com.gordan.helloffmpeg.filter.NoFilter;
import com.gordan.helloffmpeg.gles.EglCore;
...
//    private MagicFilterType type = MagicFilterType.NONE;
    private AFilter mShowFilter=new NoFilter(BaseApplication.getInstance().getResources());
