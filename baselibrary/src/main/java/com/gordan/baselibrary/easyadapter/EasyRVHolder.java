package com.gordan.baselibrary.easyadapter;
...
import com.gordan.baselibrary.easyadapter.glide.GlideRoundTransform;
import com.gordan.baselibrary.easyadapter.helper.ViewHelper;
...
public class EasyRVHolder extends RecyclerView.ViewHolder implements ViewHelper.RecyclerView<EasyRVHolder> {
    ...
    public EasyRVHolder setCircleImageUrl(int viewId, String imgUrl, int placeHolderRes) {
        ImageView view = getView(viewId);
        Glide.with(mContext).load(imgUrl).placeholder(placeHolderRes) .transform(new GlideCircleTransform()).into(view);
        return this;
    }

    public EasyRVHolder setRoundImageUrl(int viewId, String imgUrl, int placeHolderRes) {
        ImageView view = getView(viewId);
        Glide.with(mContext).load(imgUrl).placeholder(placeHolderRes) .transform(new GlideRoundTransform()).into(view);
        return this;
    }
